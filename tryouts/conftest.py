...
os.environ.update({'sleep_time': str(sleep_time)})
...
def login(request, web_browser_firefox):
    ...
    try:
        ...
        usrname_input = wait_for_element(driver, '//*[@id="mainLogin"]/form/div[1]/div/input')
        usrname_input.clear()
        usrname_input.send_keys(os.environ.get('username'))

        #
        passwd_input = wait_for_element(driver, '//*[@id="mainLogin"]/form/div[2]/div/input')

        passwd_input.clear()
        passwd_input.send_keys(os.environ.get('password'))

        #
        login_btn = wait_for_element(driver, '//*[@id="mainLogin"]/form/div[5]/button')
    ...
    def fin():
        usr_topright_span = wait_for_element(driver,
                                             '//*[@id="layout_menu_header"]/div/ul[3]/li[4]/a')

        usr_topright_span.click()
        quit_span = wait_for_element(driver,
